<?php
    ...
    if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
        ...
        $args['intro_text'] = sprintf( __( '<p>Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: <strong>$%1$s</strong></p>', 'redux-framework-demo_thanhlt' ), $v );
    } else {
        $args['intro_text'] = __( '<p>This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.</p>', 'redux-framework-demo_thanhlt' );
    }

    // Add content after the form.
    $args['footer_text'] = __( '<p>This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.</p>', 'redux-framework-demo_thanhlt' );
    ...
    $tabs = array(
        array(
            'id'      => 'redux-help-tab-1',
            'title'   => __( 'Theme Information 1', 'redux-framework-demo_thanhlt' ),
            'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'redux-framework-demo_thanhlt' )
        ),
        array(
            'id'      => 'redux-help-tab-2',
            'title'   => __( 'Theme Information 2', 'redux-framework-demo_thanhlt' ),
            'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'redux-framework-demo_thanhlt' )
        )
    );
    ...
    $content = __( '<p>This is the sidebar content, HTML is allowed.</p>', 'redux-framework-demo_thanhlt' );
